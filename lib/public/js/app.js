...
FMApp.controller("FileManagerCtr", [
    ...
    function ($scope, $http, $location) {
                ...
                .then(
                    function (response) {
                        if (Array.isArray(response.data)) {
                            ...
                            debugTrace(`function setCurFiles() was called, response data is NOT an array`);
                        }
                    },
                    function (response) {
        ...
        var displayFile = (file) => {
            // Fetch file content
            debugTrace(`HANDLER for displayFile -- file object: ${JSON.stringify(file, null, 4)}`);
            $scope.fileType = '';
            $scope.fileData = '';
            ...
            httpRequest("GET", url, null, null, {
                ...
                $scope.$apply(() => {
                    ...
                    debugTrace(`HANDLER for displayFile -- $scope.fileUrl: ${$scope.fileUrl}`);
                });
            });
        }
